...
export const Config = {
    ...
    STATIC_BIND_HOST: parseStringEnv(
        'STATIC_BIND_HOST',
        MULTIPLAYER_MODE ? '0.0.0.0' : '127.0.0.1'
    ),
    GAME_BIND_HOST: parseStringEnv(
        'GAME_BIND_HOST',
        MULTIPLAYER_MODE ? '0.0.0.0' : '127.0.0.1'
    ),
    POLICY_BIND_HOST: parseStringEnv(
        'POLICY_BIND_HOST',
        MULTIPLAYER_MODE ? '0.0.0.0' : '127.0.0.1'
    ),
    RUFFLE_SOCKET_PROXY_BIND_HOST: parseStringEnv('RUFFLE_SOCKET_PROXY_BIND_HOST', '127.0.0.1'),
    RUFFLE_SOCKET_PROXY_PORT: parseNumberEnv('RUFFLE_SOCKET_PROXY_PORT', 8090),
